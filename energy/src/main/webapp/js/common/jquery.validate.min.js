					...
					this.submit(function(d) {
						function e() {			
							if (b.settings.submitHandler) {
								if (b.submitButton)	
									var f = c("<input type='hidden'/>").attr("name",b.submitButton.name)
				...
				defaults : {
					...
					onfocusin : function(a) {
						...
						if (this.settings.focusCleanup && !this.blockFocusCleanup) {
							...
							this.settings.unhighlight && this.settings.unhighlight.call(this, a,
					...
					highlight : function(a, b, d) {
						...
						a.type === "radio" ? this.findByName(a.name)
								...
								.addClass(b).removeClass(d) : c(a).addClass(b).removeClass(d)
